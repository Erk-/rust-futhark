...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct futhark_i32_1d {
    _unused: [u8; 0],
}
extern "C" {
    pub fn futhark_new_i32_1d(
...
extern "C" {
    pub fn futhark_free_i32_1d(
        ctx: *mut futhark_context,
        arr: *mut futhark_i32_1d,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn futhark_values_i32_1d(
        ctx: *mut futhark_context,
        arr: *mut futhark_i32_1d,
        data: *mut i32,
    ) -> ::std::os::raw::c_int;
...
extern "C" {
    pub fn futhark_values_raw_i32_1d(
        ctx: *mut futhark_context,
        arr: *mut futhark_i32_1d,
    ) -> *mut ::std::os::raw::c_char;
}
extern "C" {
    pub fn futhark_shape_i32_1d(ctx: *mut futhark_context, arr: *mut futhark_i32_1d) -> *mut i64;
}
extern "C" {
    pub fn futhark_entry_dotprod(
        ctx: *mut futhark_context,
        out0: *mut i32,
        in0: *const futhark_i32_1d,
        in1: *const futhark_i32_1d,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
